...
var EditorFrame = React.forwardRef(function InnerEditorFrame(_a, ref) {
    ...
    return (React.createElement("div", __assign({ ref: ref }, rest, { className: "ch-editor-frame", style: __assign({ background: getColor(theme, ColorName.EditorGroupHeaderBackground) }, style) }),
        React.createElement("div", { className: "ch-frame-title-bar" },
            React.createElement(TabsContainer, { tabs: northPanel.tabs, showFrameButtons: true, button: button, panel: "north", theme: theme, onTabClick: onTabClick })),
        ...
        southPanel && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "ch-frame-title-bar", style: {
                ...
                React.createElement(TabsContainer, { tabs: southPanel.tabs, showFrameButtons: false, topBorder: true, panel: "south", theme: theme, onTabClick: onTabClick })),
...
function useTransition(ref, prev, next, t, backward, codeConfig) {
    ...
    return {
        ...
        southPanel: inputSouthPanel && {
            tabs: southTabs,
            style: southStyle,
            children: (React.createElement(CodeTransition, { codeConfig: codeConfig, prevFile: prevSouthFile, nextFile: nextSouthFile, t: t, parentHeight: ((southStyle === null || southStyle === void 0 ? void 0 : southStyle.height) || (southStyle === null || southStyle === void 0 ? void 0 : southStyle.minHeight)) })),
        },
    };
}
...
function EditorTween(_a) {
    ...
    var _e = __read(React.useState(undefined), 2), frozenHeight = _e[0], freezeHeight = _e[1];
