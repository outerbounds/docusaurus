...
var prompt = React__default['default'].createElement("span", { className: "ch-terminal-prompt" }, "$");
function TerminalContent(_a) {
    ...
    return (React__default['default'].createElement("pre", { style: style, className: "ch-terminal-content" }, commands.map(function (_a, i) {
...
function MiniTerminalTransition(_a) {
    ...
    return (React__default['default'].createElement(miniFrame.MiniFrame, __assign({ title: title }, rest, { className: "ch-terminal-container " + className, theme: {} }),
        React__default['default'].createElement(InnerTerminalTransition, __assign({}, { prev: prev, prevKey: prevKey, next: next, nextKey: nextKey, progress: progress }))));
}
...
function MiniTerminalTransitions(_a) {
    ...
    return (React__default['default'].createElement(MiniTerminalTransition, __assign({ title: title, prev: textSteps[prevIndex], prevKey: prevIndex, next: textSteps[nextIndex] || "", nextKey: nextIndex, progress: stepProgress }, rest)));
}
...
function MiniTerminal(_a) {
    ...
    return (React__default['default'].createElement(MiniTerminalTransitions, __assign({ steps: actualSteps, progress: progress, backward: backward, title: title }, rest)));
}

exports.InnerTerminal = InnerTerminalTransitions;
exports.MiniTerminal = MiniTerminal;
exports.TerminalContent = TerminalContent;
