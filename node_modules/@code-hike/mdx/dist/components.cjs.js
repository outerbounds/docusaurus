...
var miniBrowser = require('@code-hike/mini-browser');
...
function Code(props) {
    var _a = __read(React__default['default'].useState(props), 2), step = _a[0], setStep = _a[1];
    function onTabClick(filename) {
        var newStep = updateEditorStep(step, filename, null);
        setStep(__assign(__assign({}, step), newStep));
    }
    return React__default['default'].createElement(InnerCode, __assign({}, step, { onTabClick: onTabClick }));
}
...
var SectionContext = React__default['default'].createContext({
    props: null,
    setFocus: function () { },
    resetFocus: function () { },
});
function Section(_a) {
    ...
    return (React__default['default'].createElement(SectionContext.Provider, { value: {
            props: rest,
            setFocus: setFocus,
...
function SectionCode() {
    var _a = React__default['default'].useContext(SectionContext), props = _a.props, setFocus = _a.setFocus;
    var onTabClick = function (filename) {
        setFocus({ fileName: filename, focus: null, id: "" });
    };
    return React__default['default'].createElement(InnerCode, __assign({}, props, { onTabClick: onTabClick }));
}
function SectionLink(_a) {
    var focus = _a.focus, file = _a.file, children = _a.children, id = _a.id;
    var _b = React__default['default'].useContext(SectionContext), setFocus = _b.setFocus, resetFocus = _b.resetFocus, selectedId = _b.selectedId;
...
function SandpackPreview(_a) {
    ...
    React__default['default'].useEffect(function () {
        clientRef.current = new sandpackClient.SandpackClient(iframeRef.current, __assign(__assign({}, presetConfig), { files: mergeFiles(presetConfig.files, files) }), {
...
function Spotlight(_a) {
    ...
    var _d = __read(React__default['default'].useState({
        stepIndex: start,
    ...
    return (React__default['default'].createElement("div", { className: "ch-spotlight " + (presetConfig ? "ch-spotlight-with-preview" : "") },
        React__default['default'].createElement("div", { className: "ch-spotlight-tabs" },
            ...
            stepsChildren.map(function (children, i) {
                return i === 0 ? null : (React__default['default'].createElement("div", { key: i, onClick: function () {
                        return setState({
                            stepIndex: i,
                            step: editorSteps[i],
                        });
...
function Scrollycoding(_a) {
    ...
    var stepsChildren = React__default['default'].Children.toArray(children);
    var _c = __read(React__default['default'].useState({
        stepIndex: start,
        step: editorSteps[start],
...
function Slideshow(_a) {
    ...
    return (React__default['default'].createElement("div", { className: "ch-slideshow " + (presetConfig ? "ch-slideshow-with-preview" : "") },
        ...
        React__default['default'].createElement("div", { className: "ch-slideshow-notes" },
            React__default['default'].createElement("div", { className: "ch-slideshow-range" },
                ...
                React__default['default'].createElement("input", { type: "range", min: 0, max: editorSteps.length - 1, value: state.stepIndex, step: 1, onChange: function (e) {
                        return setState({
