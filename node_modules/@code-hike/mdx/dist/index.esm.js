    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    promises = [];
                    visit(tree, type, function (node, index, parent) {
...
function extractAnnotationsFromCode(code) {
    ...
    while (lineNumber <= lines.length) {
        ...
        var Component = annotationsMap[key];
        if (Component) {
            var focus_1 = relativeToAbsolute(focusString, lineNumber);
            lines.splice(lineNumber - 1, 1);
            annotations.push({ Component: Component, focus: focus_1, data: data });
        }
        else if (key === "focus") {
            var focus_2 = relativeToAbsolute(focusString, lineNumber);
            lines.splice(lineNumber - 1, 1);
...
function transformLinks(tree) {
    visit(tree, "link", function (linkNode) {
